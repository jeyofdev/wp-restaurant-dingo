...
class TagCloudWidget extends WP_Widget {
    ...
    {
        parent::__construct("dingo_tag_cloud_widget", __("Tag Cloud", "dingo"), [
            "classname" => "tag_cloud_widget",
			"description" => __("A cloud of your most used tag or category.", "dingo"),
			"customize_selective_refresh" => true,
        ]);

        $this->fields = [
            "title" => __("Title", "dingo"),
            "count" => __("Show tag counts ?", "dingo"),
            "taxonomy" => __("Taxonomy", "dingo")
        ];
	}
	...
	public function widget ($args, $instance)
    {
		...
		if (!empty($instance["title"])) {
            ...
            if ($current_taxonomy === "Category") {
                $instance["title"] = __("Category", "dingo");
            } if ($current_taxonomy === "post_tag") {
                $instance["title"] = __("Tags", "dingo");
            } else {
				$instance["title"] = __("Tag Clouds", "dingo");
			}
        }
